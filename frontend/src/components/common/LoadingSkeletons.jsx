  ...
  return (
    <div className="space-y-3" aria-busy="true" aria-label="Loading job opportunities">
      {Array.from({ length: count }).map((_, idx) => (
        <div
          key={idx}
          className="bg-white border border-linkedin-border rounded-[12px] p-5 animate-pulse space-y-3.5 shadow-2xs"
        >
...
export const SkeletonMetricCard = () => (
  <div className="bg-white border border-linkedin-border rounded-[12px] p-5 animate-pulse space-y-2.5 shadow-2xs">
...
export const SkeletonProfileCard = () => (
  <div className="bg-white border border-linkedin-border rounded-[12px] p-6 animate-pulse space-y-4 shadow-2xs">
