  ...
  return (
    <div className="space-y-4">
      ...
      {hasProfile && topJobs.length > 0 && (
        <div className="bg-white border border-linkedin-border rounded-[10px] p-5 shadow-sm space-y-4">
            ...
            {topJobs.map((job) => {
              ...
              return (
                <div
                  ...
                  className="p-4 rounded-xl border border-linkedin-border bg-[#FBFBFA] hover:bg-white hover:shadow-sm hover:border-linkedin-blue/40 transition-all cursor-pointer group flex flex-col sm:flex-row sm:items-center justify-between gap-3"
                >
      ...
      {/* Career Advice Card */}
      <div className="bg-white border border-linkedin-border rounded-[10px] p-5 shadow-sm hover:shadow-md transition-all duration-200">
        <div className="flex items-start justify-between gap-3 mb-3">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 rounded-full flex items-center justify-center text-emerald-700 bg-emerald-50">
