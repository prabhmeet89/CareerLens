...
const ProfileMiniCard = () => {
  ...
  return (
    <div className="bg-white dark:bg-[#141414] border border-linkedin-border rounded-[10px] overflow-hidden shadow-sm">
      {/* Cover Banner */}
      <div className="h-16 bg-gradient-to-r from-[#0A66C2] via-[#004182] to-[#002244] relative dark:ring-inset dark:ring-1 dark:ring-white/5" />

      {/* Avatar & User Details */}
      <div className="px-4 pb-4 pt-0 text-center relative -mt-9">
        <div className="inline-block relative">
          <div className="w-16 h-16 rounded-full bg-linkedin-blue text-white font-bold text-xl flex items-center justify-center border-2 border-white dark:border-[#141414] shadow-md mx-auto">
            {getInitials(user?.name)}
          </div>
          <div className="absolute bottom-0 right-0 w-4 h-4 bg-emerald-500 rounded-full border-2 border-white dark:border-[#141414]" title="Active" />
        </div>
      ...
      <div className="border-t border-linkedin-border py-2 text-xs">
        <div className="px-4 py-1.5 flex justify-between items-center hover:bg-gray-50 dark:hover:bg-[#1A1A1A] transition-colors cursor-pointer">
      ...
      <div className="border-t border-linkedin-border px-4 py-2.5 hover:bg-gray-50 dark:hover:bg-[#1A1A1A] transition-colors cursor-pointer flex items-center gap-2 text-xs font-semibold text-linkedin-text-primary">
